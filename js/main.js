...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initScrollAnimation)\n/* harmony export */ });\nfunction initScrollAnimation() {\n  var sections = document.querySelectorAll('[data-anime=\"scroll\"]'); // Atribui 75% da altura do browser\n\n  var windowMetade = window.innerHeight * 0.75;\n\n  function animaScroll() {\n    // Percorre as seções\n    sections.forEach(function (section) {\n      // Atribui a distancia que a seção está do topo\n      var sectionTop = section.getBoundingClientRect().top; // Atribui distancia que a seção está do topo menos 75%\n\n      var isSectionVisible = sectionTop - windowMetade; // Se a distancia for menor que 0 (seção está visivel)\n\n      if (isSectionVisible < 0) {\n        // Adiciona a classe ativo a seção\n        section.classList.add(\"ativo\");\n      } else if (section.classList.contains(\"ativo\")) {\n        section.classList.remove(\"ativo\");\n      }\n    });\n  }\n\n  if (sections.length) {\n    // Ativa a função quando entrar no site\n    animaScroll(); // Adiciona o evento de scroll ao janela do browser\n\n    window.addEventListener(\"scroll\", animaScroll);\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/scroll-anim.js?");
